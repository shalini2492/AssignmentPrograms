...
public class BLRandom {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            BLStdOut.printf("%2d ",   uniform(100));
            BLStdOut.printf("%8.5f ", uniform(10.0, 99.0));
            BLStdOut.printf("%5b ",   bernoulli(0.5));
            BLStdOut.printf("%7.5f ", gaussian(9.0, 0.2));
            BLStdOut.printf("%1d ",   discrete(probabilities));
            BLStdOut.printf("%1d ",   discrete(frequencies));
            BLStdOut.printf("%11d ",  uniform(100000000000L));
            BLRandom.shuffle(a);
            for (String s : a)
                BLStdOut.print(s);
            BLStdOut.println();
