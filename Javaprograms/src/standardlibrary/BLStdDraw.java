...
public final class BLStdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static BLStdDraw std = new BLStdDraw();
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
            URL url = BLStdDraw.class.getResource(filename);
            if (url != null)
                icon = new ImageIcon(url);
        }
...
*/
    ...
    ***************************************************************************/
    ...
    public void actionPerformed(ActionEvent e) {
        FileDialog chooser = new FileDialog(BLStdDraw.frame, "Use a .png or .jpg extension", FileDialog.SAVE);
        chooser.setVisible(true);
        String filename = chooser.getFile();
        if (filename != null) {
            BLStdDraw.save(chooser.getDirectory() + File.separator + chooser.getFile());
        }
    }
    ...
    ***************************************************************************/
    ...
    public void mousePressed(MouseEvent e) {
        synchronized (mouseLock) {
            mouseX = BLStdDraw.userX(e.getX());
            mouseY = BLStdDraw.userY(e.getY());
            isMousePressed = true;
        }
    }
    ...
    *  as an argument. It can handle action keys
    ...
    public static void main(String[] args) {
        BLStdDraw.square(0.2, 0.8, 0.1);
        BLStdDraw.filledSquare(0.8, 0.8, 0.2);
        BLStdDraw.circle(0.8, 0.2, 0.2);

        BLStdDraw.setPenColor(BLStdDraw.BOOK_RED);
        BLStdDraw.setPenRadius(0.02);
        BLStdDraw.arc(0.8, 0.2, 0.1, 200, 45);

        // draw a blue diamond
        BLStdDraw.setPenRadius();
        BLStdDraw.setPenColor(BLStdDraw.BOOK_BLUE);
        double[] x = { 0.1, 0.2, 0.3, 0.2 };
        double[] y = { 0.2, 0.3, 0.2, 0.1 };
        BLStdDraw.filledPolygon(x, y);

        // text
        BLStdDraw.setPenColor(BLStdDraw.BLACK);
        BLStdDraw.text(0.2, 0.5, "black text");
        BLStdDraw.setPenColor(BLStdDraw.WHITE);
        BLStdDraw.text(0.8, 0.8, "white text");
    }
